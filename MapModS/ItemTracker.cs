...
namespace MapModS
{
    internal class ItemTracker : HookModule
    {
        ...
        private class TrackGeoRock : FsmStateAction
        {
            ...
            public override void OnEnter()
            {
                ...
                MapModS.Instance.LogDebug("Geo Rock broken");
                MapModS.Instance.LogDebug(" ID: " + grd.id);
                MapModS.Instance.LogDebug(" Scene: " + grd.sceneName);
            }
        }
        ...
        private class TrackItem : FsmStateAction
        {
            ...
            public override void OnEnter()
            {
                ...
                MapModS.Instance.LogDebug("Item picked up");
                MapModS.Instance.LogDebug(" Name: " + name);
                MapModS.Instance.LogDebug(" Scene: " + scene);
            }
        }
        ...
        internal static void LoadTrackingDefs()
        {
            trackingDefs = JsonUtil.Deserialize<Dictionary<string, TrackingDef>>("MapModS.Resources.tracking.json");
        }
        ...
        internal static void VerifyTrackingDefs()
        {
            ...
            {
                MapModS.Instance.LogDebug($"Has {name}: {HasClearedLocation(name)}");
            }
        }
        ...
        internal static bool HasClearedLocation(string name)
        {
            if (trackingDefs.TryGetValue(name, out TrackingDef td))
            {
                ...
                MapModS.Instance.LogDebug($"Everything is null!");
            }
            return false;
        }
