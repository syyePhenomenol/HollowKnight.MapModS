...
namespace RandoMapMod.Transition
{
    public static class PathfinderData
    {
        ...
        {
            conditionalTerms = JsonUtil.Deserialize<Dictionary<string, string>>("MapModS.RandoMapMod.Resources.Pathfinder.Data.conditionalTerms.json");
            adjacentScenes = JsonUtil.Deserialize<Dictionary<string, string>>("MapModS.RandoMapMod.Resources.Pathfinder.Data.adjacentScenes.json");
            adjacentTerms = JsonUtil.Deserialize<Dictionary<string, string>>("MapModS.RandoMapMod.Resources.Pathfinder.Data.adjacentTerms.json");
            scenesByTransition = JsonUtil.Deserialize<Dictionary<string, string>>("MapModS.RandoMapMod.Resources.Pathfinder.Data.scenesByTransition.json");
            transitionsByScene = JsonUtil.Deserialize<Dictionary<string, HashSet<string>>>("MapModS.RandoMapMod.Resources.Pathfinder.Data.transitionsByScene.json");
            doorObjectsByScene = JsonUtil.Deserialize<Dictionary<string, string>>("MapModS.RandoMapMod.Resources.Pathfinder.Compass.doorObjectsByScene.json");
            doorObjectsByTransition = JsonUtil.Deserialize<Dictionary<string, string>>("MapModS.RandoMapMod.Resources.Pathfinder.Compass.doorObjectsByTransition.json");
